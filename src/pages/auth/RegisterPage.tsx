    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">انضم إلى آلاف الطلاب</p>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">الاسم رباعي</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">رقم الهاتف (الخاص بك)</label>
              <input
                type="tel"
                value={phone}
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">رقم هاتف ولي الأمر</label>
              <input
                type="tel"
                value={parentPhone}
