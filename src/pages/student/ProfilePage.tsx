  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-6 shadow-lg">
        <div className="w-20 h-20 rounded-full bg-primary/20 border-2 border-primary/50 flex items-center justify-center text-primary text-2xl font-bold flex-shrink-0 overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="bg-card border border-border rounded-2xl p-4 text-center shadow-lg">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 space-y-4 shadow-lg">
        ...
        <div>
          ...
          <input
            ...
            disabled
            dir="ltr"
            className="w-full bg-background border border-border rounded-xl px-4 py-3 text-muted cursor-not-allowed text-left"
          />
        </div>
        <div className="flex gap-3">
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex-1 bg-primary hover:brightness-110 text-white font-bold py-3 rounded-xl transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 border border-red-500/30 text-red-400 hover:bg-red-500/10 px-4 py-3 rounded-xl font-bold transition-colors"
          >
