...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 right-0 z-50 w-64 bg-card shadow-lg border-l border-border transform transition-transform duration-300 lg:relative lg:translate-x-0 flex flex-col ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <nav className="p-4 space-y-1 flex-1 overflow-y-auto">
          ...
          <button
            ...
            className="flex items-center w-full px-4 py-2.5 rounded-xl text-red-500 hover:bg-red-500/10 transition-colors text-sm mt-2"
          >
